...
import com.whatcable.android.ui.cabletest.CableTestScreen
    ...
    NavHost(
        ...
        composable("home") {
            HomeScreen(
                ...
                onCableTestClick = { navController.navigate("cabletest") }
            )
        }
        ...
        composable("cabletest") {
            CableTestScreen(onBack = { navController.popBackStack() })
        }
